...
namespace Biblioteca
{
    public class Serealizadores<T>
    {
        ...
        public static bool SerealizarXML(String archivo, List<T> lista)
        {
            ...
            {
                throw new SerealizadoresException("Excepcion controlada. Ha ocurrido un error mientras se Serializaba");
            }
        }
        /// <summary>
        ...
        public static List<T> DeserealizarXML(String archivo)
        {
            ...
            {
                throw new SerealizadoresException("Excepcion controlada. Ha ocurrido un error mientras se Deserializaba ");
            }
        }
        /// <summary>
        ...
        public static bool GuardarTxt(String archivo, String queGuardar)
        {
            ...
            {
                throw new SerealizadoresException("Excepcion controlada. Ha ocurrido un error mientras se Guardaba");
            }
        }
        #endregion
