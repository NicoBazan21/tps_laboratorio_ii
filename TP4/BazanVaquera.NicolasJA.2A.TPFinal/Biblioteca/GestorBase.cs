...
namespace Biblioteca
{
    public class GestorBase<T> where T : Persona
    {
            ...
            try
            {
                lista = await Task.Run(() =>
                {
                    try
                    {
                        ...
                        {
                            //consulta = "select clientePrueba.dni,clientePrueba.nombreCompleto,turnoPruebaa.nombreDoctor,turnoPruebaa.idDerivacion,turnoPruebaa.fecha,turnoPruebaa.hora from clientePrueba inner join turnoPruebaa on clientePrueba.dni = turnoPruebaa.dni";
                        ...
                        {
                            //consulta = "select * from ClientePrueba";
        ...
        /// <summary>
        /// Metodo que elimina todo de las dos bases de datos
        /// </summary>
        ...
        /// <summary>
        /// Metodo normal, que ejecuta el comando con el mensaje que se recibe
        /// </summary>
